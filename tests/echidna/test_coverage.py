...
to_test = [
    ...
    ("CoverageStaticTuple.sol", "inst-inc", 5),
    ("CoverageNestedTuple.sol", "inst-inc", 5),
    ("CoverageNestedArrays1.sol", "inst-inc", 1),
    ("CoverageNestedArrays2.sol", "inst-inc", 1),
    ("CoverageNestedArrays3.sol", "inst-inc", 1),
    ("CoverageFixedArray.sol", "inst-inc", 10),
    ("CoverageDynamicArray.sol", "inst-inc", 10),
    ("CoverageArrayOfTuple.sol", "inst-inc", 1),
    ("CoverageDynamicTuple1.sol", "inst-inc", 1),
    ("CoverageDynamicTuple3.sol", "inst-inc", 1),
    ("CoverageDynamicTuple2.sol", "inst-inc", 1),
    ("Time.sol", "inst", 10),
    ("SmartianExample.sol", "inst-inc", 40),
    ("Payable.sol", "inst", 10),
    ("IntCast.sol", "inst", 10),
    ("CreateContracts.sol", "inst-inc", 10),
    ("CreateContracts2.sol", "inst-inc", 30),
    ("MessageCall.sol", "inst-inc", 1),
    ("Reentrency.sol", "inst-inc", 20),
]
